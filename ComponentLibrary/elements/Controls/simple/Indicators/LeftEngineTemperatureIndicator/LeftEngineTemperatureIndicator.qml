...
BaseSceneComponent {
    ...
    previewSource: "Pribor_001_background.svg"
    ...
    readonly property real backgroundSourceWidth: 211.9
    readonly property real backgroundSourceHeight: 220.1
    ...
    Item {
        ...
        AdaptiveSvgImage {
            anchors.fill: parent
            source: Qt.resolvedUrl("Pribor_001_background.svg")
        ...
        Item {
            id: bigNeedlePivot
            objectName: "leftTemperatureLargeNeedle"
            ...
            AdaptiveSvgImage {
                id: bigNeedleImage
                objectName: "leftTemperatureLargeNeedleImage"
                source: Qt.resolvedUrl("Strelka_bloshaya_pribor_001.svg")
                width: 35.1
                height: 192.7
                x: -17.55
                y: -96.35
                ...
                Item {
                    objectName: "leftTemperatureLargeNeedleAxis"
                    x: 17.55
                    y: 96.35
                    width: 0
                    height: 0
        ...
        Item {
            id: smallNeedlePivot
            objectName: "leftTemperatureSmallNeedle"
            x: root.smallCenterX
            y: root.smallCenterY
            ...
            AdaptiveSvgImage {
                id: smallNeedleImage
                objectName: "leftTemperatureSmallNeedleImage"

                source: Qt.resolvedUrl("Strelka_malaya_pribor_001.svg")
                width: 10.8
                height: 57.8
                x: -5.4
                y: -28.9
                ...
                Item {
                    objectName: "leftTemperatureSmallNeedleAxis"
                    x: 5.4
                    y: 28.9
                    width: 0
                    height: 0
